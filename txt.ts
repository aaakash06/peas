...
//     this.periods = {}; // Key: classId, Value: number of periods taught in that class
//   }
// }
...
//   constructor(id) {
//     this.id = id;
//     this.schedule = {}; // Key: date, Value: array of periods
//   }

//   assignSchedule(date, periods) {
//     this.schedule[date] = periods;
//   }
// }
